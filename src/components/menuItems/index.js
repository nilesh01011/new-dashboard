    ...
    return (
        ...
        >
            <button type='button' className={`flex flex-col ${isOpen ? 'justify-center group' : 'justify-between'} relative items-center w-full mb-[4px]`}>
                ...
                {/* show tooltips */}
                <div className={`group-hover:block hidden rounded-[5px] absolute top-0 left-[56px] w-[200px] p-[5px] h-max z-[99999] border-[1px] bg-[#ffffff] border-[#E6E6E6]`}>
                    {/* right arrow */}
                    ...
                    <ul className='w-full flex flex-col gap-1'>
                        <li className={`w-auto whitespace-nowrap h-[22px] ${miniTabsOpen === true && `text-[#FF3E5B]`} text-left pl-[16px] pr-[10px] rounded text-[12px]`}>
                        ...
                        </li>
                        {
                            ...
                            <ul className='w-full flex flex-col gap-1 bg-[#f2f2f2] p-[3px]'>
                                <li onClick={() => { setInnerTabsActive(1) }} className={`w-auto whitespace-nowrap pl-[26px] ${pathname === suggestPathname && `text-[#FF3E5B] bg-[#F2F2F2]`} ${innerTabsActive === 1 ? `text-[#FF3E5B] bg-[#F2F2F2]` : `text-[#342C2C] hover:bg-[#fff]`} text-left rounded py-[5px] text-[12px]`}>
                                    {/* <span className={`text-[#FF3E5B]`}> */}
                                    Delight To Win
                                    {/* </span> */}
                                </li>
                                <li onClick={() => setInnerTabsActive(2)} className={`w-auto whitespace-nowrap pl-[26px] ${innerTabsActive === 2 ? `text-[#FF3E5B] bg-[#F2F2F2]` : `text-[#342C2C] hover:bg-white`} text-left rounded py-[5px] text-[12px]`}>Sales</li>
                                <li onClick={() => setInnerTabsActive(3)} className={`w-auto whitespace-nowrap pl-[26px] ${innerTabsActive === 3 ? `text-[#FF3E5B] bg-[#F2F2F2]` : `text-[#342C2C] hover:bg-white`} text-left rounded py-[5px] text-[12px]`}>Manufacturing</li>
                            </ul>
                        }
                ...
                <div className='w-full'>
                    {
                        ...
                        <ul className='w-full flex flex-col'>
                            <li className={`w-auto whitespace-nowrap h-[40px] flex items-center text-left pl-[30px] pr-[10px] rounded py-[5px] text-[12px]`}>
                                <div onClick={() => { setMiniTabsOpen(!miniTabsOpen) }} className='w-full flex justify-between items-center'>
                                    <span style={{ color: miniTabsOpen === true && '#FF3E5B' }}>PV Dashboard</span>
                            ...
                            </li>
                            {
                                ...
                                <ul className='w-full pl-[21px] flex flex-col gap-1 bg-[#f2f2f2]'>
                                    <li onClick={() => { setInnerTabsActive(1) }}
                                        className={`w-auto whitespace-nowrap ${pathname === suggestPathname && `text-[#FF3E5B] bg-[#F2F2F2]`} ${innerTabsActive === 1 ? `text-[#FF3E5B] bg-[#F2F2F2]` : ` text-[#342C2C]`} text-left pl-[20px] rounded py-[5px] text-[12px]`}>
                                        Delight to Win
                                    </li>
                                    <li onClick={() => setInnerTabsActive(2)} className={`w-auto whitespace-nowrap ${innerTabsActive === 2 ? `text-[#FF3E5B]` : ''} bg-[#F2F2F2] text-left pl-[20px] rounded py-[5px] hover:text-[#FF3E5B] text-[12px]`}>Sales</li>
                                    <li onClick={() => setInnerTabsActive(3)} className={`w-auto whitespace-nowrap ${innerTabsActive === 3 ? `text-[#FF3E5B]` : ''} bg-[#F2F2F2] text-left pl-[20px] rounded py-[5px] hover:text-[#FF3E5B] text-[12px]`}>Manufacturing</li>
                                </ul>
                            }
                        </ul>
                    }
